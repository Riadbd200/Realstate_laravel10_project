            ...
            <div class="d-flex align-items-center justify-content-between mb-2">
              <div>
                ...
                class="wd-100 rounded-circle"
                 src="{{(!empty($profileData->photo)) ? url('upload/agent/'. $profileData->photo) : url('upload/agent/no_image.jpg')}}" alt="profile"><br><br>
                <span class="h4 ms-1">{{$profileData->username}}</span>
              </div>
            </div>
                    ...
                    <form method="POST" action="{{route('agent.profile.store')}}" enctype="multipart/form-data" class="forms-sample">
                      ...
                      @csrf 
                        ...
                        <div class="mb-3">
                            ...
                            src="{{(!empty($profileData->photo)) ? url('upload/agent/'. $profileData->photo) : url('upload/agent/no_image.jpg')}}" alt="profile">
                        </div>
