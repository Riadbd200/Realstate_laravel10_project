            ...
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Add Property</h6>
                        <form id="myForm" action="{{route('agent.store.property')}}" method="POST" enctype="multipart/form-data">
                            @csrf 
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control" name="short_descrip"  rows="4"></textarea>
                                </div>
                            </div><!-- Col -->
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control" name="long_descrip" name="tinymce" id="tinymceExample" rows="10"></textarea>
                                </div>
                            </div><!-- Col -->
