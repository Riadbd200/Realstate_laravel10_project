            ...
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Update Property</h6>
                        <form id="myForm" action="{{route('agent.update.property')}}" method="POST" enctype="multipart/form-data">
                            @csrf 
            ...
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Update Main Thumbnail Image</h6>
                        <form id="myForm" action="{{route('agent.update.property.thumbnail')}}" method="POST" enctype="multipart/form-data">
                            @csrf 
        ...
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Update Property Multi Image</h6>
                    <form id="myForm" action="{{route('agent.update.property.multiimage')}}" method="POST" enctype="multipart/form-data">
                        @csrf 
                    ...
                    <form id="myForm" action="{{route('agent.store.new.multiimage')}}" method="POST" enctype="multipart/form-data">
                        @csrf 
          ...
          <div class="card">
              <div class="card-body">
                  <h6 class="card-title">Update Property Facility</h6>
                      <form id="myForm" action="{{route('agent.update.property.facility')}}" method="POST" enctype="multipart/form-data">
                          @csrf 
