            ...
            <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                <div class="blog-details-content">
                    <div class="news-block-one">
                        <div class="inner-box">
                            <div class="image-box">
                                ...
                                <span class="category">{{$blog['category']['category_name']}}</span>
                            </div>
                            <div class="lower-content">
                                <h3>{{$blog->title}}</h3>
                                <ul class="post-info clearfix">
                                    <li class="author-box">
                                        <figure class="author-thumb"><img src="{{(!empty($blog->user->photo)) ? url('upload/admin/'. $blog->user->photo) : url('upload/admin/no_image.jpg')}}" alt=""></figure>
                        ...
                        <div class="comment-box">
                            ...
                            <div class="comment">
                                ...
                                <div class="comment-inner">
                                    ...
                                    <div class="text">
                                        <p class="text-warning">{{$item->subject}}</p>
                    ...
                    <div class="comments-form-area">
                        ...
                        <p><b>For Add Comment you need to first login <a href="{{route('login')}}">Login Here</a></b></p>
