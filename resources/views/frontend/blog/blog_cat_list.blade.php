...
@section('title')
{{$breadCat->category_name}} | Real State 
@endsection
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 news-block">
                            <div class="news-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><a href="{{url('blog/details/'.$item->slug)}}"><img src="{{asset($item->image)}}" alt=""></a></figure>
                                        <span class="category">Featured</span>
                                    </div>
                                    <div class="lower-content">
                                        <h4><a href="{{url('blog/details/'.$item->slug)}}">{{$item->title}}</a></h4>
                                        <ul class="post-info clearfix">
                                            <li class="author-box">
                                                <figure class="author-thumb"><img src="{{(!empty($item->user->photo)) ? url('upload/admin/'. $item->user->photo) : url('upload/admin/no_image.jpg')}}" alt=""></figure>
                                        ...
                                        <div class="btn-box">
                                            <a href="{{url('blog/details/'.$item->slug)}}" class="theme-btn btn-two">See Details</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="blog-sidebar">
                    ...
                    <div class="sidebar-widget category-widget">
                        ...
                        <div class="widget-content">
                            <ul class="category-list clearfix">
                                ...
                                <li><a href="{{url('blog/category/list/'.$item->id)}}">{{$item->category_name}}<span>({{count($post)}})</span></a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                    <div class="sidebar-widget post-widget">
                        ...
                        <div class="post-inner">
                            ...
                            <div class="post">
                                <figure class="post-thumb"><a href="{{url('blog/details/'.$item->slug)}}"><img src="{{asset($item->image)}}" alt=""></a></figure>
                                <h5><a href="{{url('blog/details/'.$item->slug)}}">{{$item->title}}</a></h5>
