                        ...
                        <form action="{{route('all.property.search')}}" method="post" class="search-form">
                            ...
                            <div class="widget-content">
                                <div class="select-box">
                                    ...
                                    <option data-display="All Status" selected disabled>All Status</option>
                                ...
                                <div class="select-box">
                                    <select class="wide" name="bathrooms">
                                        <option data-display="Bathroom">Max Bathroom</option>
                ...
                <div class="property-content-side">
                    <div class="item-shorting clearfix">
                        <div class="left-column pull-left">
                            <h5>Search Reasults: <span>Showing {{count($rentPropertyList)}} Listings</span></h5>
                        </div>
                    ...
                    <div class="wrapper list">
                        <div class="deals-list-content list-item">
                            ...
                            @foreach($rentPropertyList as $items)
                            <div class="deals-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><img src="{{asset($items->property_thumbnail)}}" alt="" style="width:300px; height:350px;"></figure>
                                        ...
                                        <div class="buy-btn"><a href="property-details.html">For {{$items->property_status}}</a></div>
                                    </div>
                                    <div class="lower-content">
                                        <div class="title-text"><h4><a href="{{url('property/details/'.$items->id .'/'.$items->property_slug)}}">{{$items->property_name}}</a></h4></div>
                                        <div class="price-box clearfix">
                                            <div class="price-info pull-left">
                                                <h6>Start From</h6>
                                                <h4>${{$items->lowest_price}}</h4>
                                            </div>

                                            @if($items->agent_id == NULL)
                                            ...
                                            @else 
                                                <div class="author-box pull-right">
                                                <figure class="author-thumb"><img src="{{(!empty($items->user->photo)) ? url('upload/agent/'. $items->user->photo) : url('upload/agent/no_image.jpg')}}" alt=""></figure>
                                        ...
                                        <p>{{$items->short_descrip}}</p>
                                        <ul class="more-details clearfix">
                                            <li><i class="icon-14"></i>{{$items->bedrooms}} Beds</li>
                                         <li><i class="icon-15"></i>{{$items->bathrooms}} Baths</li>
                                        <li><i class="icon-16"></i>{{$items->property_size}} Sq Ft</li>
                                        </ul>
                                        <div class="other-info-box clearfix">
                                            <div class="btn-box pull-left"><a href="{{url('property/details/'.$items->id .'/'.$items->property_slug)}}" class="theme-btn btn-two">See Details</a></div>
                                            <ul class="other-option pull-right clearfix">
                                                <li><a aria-label="Compare" class="action-btn" id="{{$items->id}}" onclick="addToCompare(this.id)"><i class="icon-12"></i></a></li>
                                            <li><a aria-label="Add to Wishlist" class="action-btn" id="{{$items->id}}" onclick="addToWishlist(this.id)"><i class="icon-13"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="pagination-wrapper">
                        {{$rentPropertyList->links('vendor.pagination.custom')}} 
                    </div>
                </div>
            </div>
        </div>
