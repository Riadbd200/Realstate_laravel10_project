...
@section('title')
{{$property->property_name}} | Real State 
@endsection
                ...
                <div class="author-info clearfix">
                    <div class="author-box pull-left">
                        ...
                        @if($property->agent_id == NULL)
                            ...
                            <h6>Admin</h6>
                        @else 
                        <figure class="author-thumb"><img src="{{(!empty($property->user->photo)) ? url('upload/agent/'. $property->user->photo) : url('upload/agent/no_image.jpg')}}" alt=""></figure>
            ...
            <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                <div class="property-details-content">
                    ...
                    <div class="amenities-box content-widget">
                        ...
                        <ul class="list clearfix">
                            @foreach($property_amenities as $aminity)
                            <li>{{$aminity}}</li>
                            @endforeach
                        </ul>
                    </div>
                        ...
                        <div class="author-box">
                            ...
                            <div class="inner">
                                ...
                                <ul class="info clearfix">
                                    ...
                                    <li><i class="fas fa-phone"></i><a href="">{{$property->user->phone}}</a></li>
                                </ul> 
                            ...
                            <div class="lower-content">
                                <div class="author-info clearfix">
                                    <div class="author pull-left">
                                        ...
                                        <h6>Admin</h6>
                                        @else 
                                        <figure class="author-thumb"><img src="{{(!empty($item->user->photo)) ? url('upload/agent/'. $item->user->photo) : url('upload/agent/no_image.jpg')}}" alt=""></figure>
