        ...
        <div class="top-inner clearfix">
            ...
            <div class="right-column pull-right">
                <ul class="social-links clearfix">
                    <li><a target="_blank" href="{{$siteSetting->facebook}}"><i class="fab fa-facebook-f"></i></a></li>
                    <li><a target="_blank" href="{{$siteSetting->twitter}}"><i class="fab fa-twitter"></i></a></li>
...
<div class="main-box">
<div class="logo-box">
<figure class="logo"><a href="{{url('/')}}"><img src="{{asset($siteSetting->logo)}}" alt=""></a></figure>
</div>
