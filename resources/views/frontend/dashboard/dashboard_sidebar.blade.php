...
<div class="widget-content">
    <ul class="category-list ">
            ...
            <li><a href="{{route('user.wishlist')}}"><i class="fa fa-list-alt" aria-hidden="true"></i></i> Wishlist </a></li>
            <li><a href="{{route('live.chat')}}"><i class="fa fa-list-alt" aria-hidden="true"></i></i> Live Chat </a></li>
