            ...
            <div class="d-flex align-items-center justify-content-between mb-2">
              <div>
                ...
                class="wd-100 rounded-circle"
                 src="{{(!empty($profileData->photo)) ? url('upload/admin/'. $profileData->photo) : url('upload/admin/no_image.jpg')}}" alt="profile"><br><br>
                    ...
                    <form method="POST" action="{{route('admin.profile.store')}}" enctype="multipart/form-data" class="forms-sample">
                      ...
                      @csrf 
                        ...
                        <div class="mb-3">
                            ...
                            src="{{url('upload/admin/no_image.jpg')}}" alt="profile">
                        </div>
