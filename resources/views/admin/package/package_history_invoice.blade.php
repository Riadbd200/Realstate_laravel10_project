  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>Textile Today</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               Textile Today Head Office
               Email:zakir@textiletoday.com.bd <br>
               Mob: 1245454545 <br>
               Dhaka 1230,Uttara:Lake Drive Road <br>
